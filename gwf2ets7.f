      MODULE GWFETSMODULE
        ...
        INTEGER,      SAVE, DIMENSION(:,:),   POINTER,CONTIGUOUS::IETS
        REAL,         SAVE, DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSR
        REAL,         SAVE, DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSX
        REAL,         SAVE, DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSS
        REAL,         SAVE, DIMENSION(:,:,:), POINTER,CONTIGUOUS::PXDP
        REAL,         SAVE, DIMENSION(:,:,:), POINTER,CONTIGUOUS::PETM
      TYPE GWFETSTYPE
        INTEGER, POINTER   ::NETSOP,IETSCB,NPETS,IETSPF,NETSEG
        INTEGER,       DIMENSION(:,:),   POINTER,CONTIGUOUS::IETS
        REAL,          DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSR
        REAL,          DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSX
        REAL,          DIMENSION(:,:),   POINTER,CONTIGUOUS::ETSS
        REAL,          DIMENSION(:,:,:), POINTER,CONTIGUOUS::PXDP
        REAL,          DIMENSION(:,:,:), POINTER,CONTIGUOUS::PETM
      END TYPE
...
C  Deallocate ETS MEMORY
      USE GWFETSMODULE
C
        DEALLOCATE(GWFETSDAT(IGRID)%NETSOP)
        DEALLOCATE(GWFETSDAT(IGRID)%IETSCB)
        DEALLOCATE(GWFETSDAT(IGRID)%NPETS )
        DEALLOCATE(GWFETSDAT(IGRID)%IETSPF)
        DEALLOCATE(GWFETSDAT(IGRID)%NETSEG)
        DEALLOCATE(GWFETSDAT(IGRID)%IETS  )
        DEALLOCATE(GWFETSDAT(IGRID)%ETSR  )
        DEALLOCATE(GWFETSDAT(IGRID)%ETSX  )
        DEALLOCATE(GWFETSDAT(IGRID)%ETSS  )
        DEALLOCATE(GWFETSDAT(IGRID)%PXDP  )
        DEALLOCATE(GWFETSDAT(IGRID)%PETM  )
C
