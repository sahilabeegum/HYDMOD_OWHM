      MODULE GWFEVTMODULE
        ...
        REAL,    SAVE,   DIMENSION(:,:),  POINTER,CONTIGUOUS::EVTR
        REAL,    SAVE,   DIMENSION(:,:),  POINTER,CONTIGUOUS::EXDP
        REAL,    SAVE,   DIMENSION(:,:),  POINTER,CONTIGUOUS::SURF
        INTEGER, SAVE,   DIMENSION(:,:),  POINTER,CONTIGUOUS::IEVT
      TYPE GWFEVTTYPE
        INTEGER,  POINTER                 ::NEVTOP,IEVTCB
        INTEGER,  POINTER                 ::NPEVT,IEVTPF
        REAL,       DIMENSION(:,:),  POINTER,CONTIGUOUS::EVTR
        REAL,       DIMENSION(:,:),  POINTER,CONTIGUOUS::EXDP
        REAL,       DIMENSION(:,:),  POINTER,CONTIGUOUS::SURF
        INTEGER,    DIMENSION(:,:),  POINTER,CONTIGUOUS::IEVT
      END TYPE
