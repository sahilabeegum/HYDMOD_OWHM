      MODULE GWFSTRMODULE
        ...
        REAL,   SAVE,  POINTER,  DIMENSION(:,:),CONTIGUOUS::STRM
        REAL,   SAVE,  POINTER,  DIMENSION(:)  ,CONTIGUOUS::ARTRIB
        INTEGER,SAVE,  POINTER,  DIMENSION(:,:),CONTIGUOUS::ISTRM
        INTEGER,SAVE,  POINTER,  DIMENSION(:,:),CONTIGUOUS::ITRBAR
        INTEGER,SAVE,  POINTER,  DIMENSION(:)  ,CONTIGUOUS::IDIVAR
        INTEGER,SAVE,  POINTER,  DIMENSION(:)  ,CONTIGUOUS::NDFGAR
        CHARACTER(LEN=16),SAVE, DIMENSION(:), POINTER,CONTIGUOUS::STRAUX
      TYPE GWFSTRTYPE
        ...
        REAL,   POINTER,  DIMENSION(:,:),CONTIGUOUS::STRM
        REAL,   POINTER,  DIMENSION(:)  ,CONTIGUOUS::ARTRIB
        INTEGER,POINTER,  DIMENSION(:,:),CONTIGUOUS::ISTRM
        INTEGER,POINTER,  DIMENSION(:,:),CONTIGUOUS::ITRBAR
        INTEGER,POINTER,  DIMENSION(:)  ,CONTIGUOUS::IDIVAR
        INTEGER,POINTER,  DIMENSION(:)  ,CONTIGUOUS::NDFGAR
        CHARACTER(LEN=16), DIMENSION(:),   POINTER,CONTIGUOUS::STRAUX
      END TYPE
