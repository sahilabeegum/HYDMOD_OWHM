...
C
      MODULE GWFIBSMODULE
        ...
        INTEGER, SAVE,    DIMENSION(:),     POINTER,CONTIGUOUS::IBQ
        INTEGER, SAVE,    DIMENSION(:),     POINTER,CONTIGUOUS::IBQ1
      ...
      TYPE GWFIBSTYPE
        ...
        INTEGER,    DIMENSION(:),     POINTER,CONTIGUOUS::IBQ
        INTEGER,    DIMENSION(:),     POINTER,CONTIGUOUS::IBQ1
