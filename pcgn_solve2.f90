...
module common_solver_types
  ...
  ! ... arrays
  real(kind=kv), dimension(:), CONTIGUOUS, pointer :: DD, DX, DY, DZ          !seb added CONTIGUOUS FLAG. IF THIS CAUSES PROBLEMS, REMOVE IT
  real(kind=kv), dimension(:), CONTIGUOUS, pointer :: dx0, dy0, dz0       
  real(kind=kv), dimension(:), CONTIGUOUS, pointer :: dx1, dy1, dz1
  real(kind=kv), dimension(:), CONTIGUOUS, pointer :: diag
