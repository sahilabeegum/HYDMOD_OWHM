      MODULE DE4MODULE
        ...
        INTEGER,SAVE, POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::IUPPNT
        INTEGER,SAVE, POINTER, DIMENSION(:,:,:),CONTIGUOUS ::IEQPNT
        REAL,   SAVE, POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::AU
        REAL,   SAVE, POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::AL
        REAL,   SAVE, POINTER, DIMENSION(:)    ,CONTIGUOUS ::D4B
        REAL,   SAVE, POINTER, DIMENSION(:)    ,CONTIGUOUS ::HDCGDE4
        INTEGER,SAVE, POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::LRCHDE4
      TYPE DE4TYPE
        ...
        INTEGER,POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::IUPPNT
        INTEGER,POINTER, DIMENSION(:,:,:),CONTIGUOUS ::IEQPNT
        REAL,   POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::AU
        REAL,   POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::AL
        REAL,   POINTER, DIMENSION(:)    ,CONTIGUOUS ::D4B
        REAL,   POINTER, DIMENSION(:)    ,CONTIGUOUS ::HDCGDE4
        INTEGER,POINTER, DIMENSION(:,:)  ,CONTIGUOUS ::LRCHDE4
      END TYPE
...
C6B-----WRITE BAND WIDTH + 1 AND NUMBER OF EQUATIONS IF ANY HAVE CHANGED.
  ...
  351    FORMAT(1X,/1X,I7,' UPPER PART EQS.',
     1     I10,' LOWER PART EQS.    BAND WIDTH + 1 =',I7)
         NUPL=NUP
         NLOWL=NLOW
         NBWL=NBW
      END IF
