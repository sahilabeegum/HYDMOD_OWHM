     ...
     1                           NFHBX2,IFHBSS
        INTEGER, SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::IFLLOC
        INTEGER, SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::IHDLOC
        REAL,    SAVE, POINTER, DIMENSION(:)  ,CONTIGUOUS::BDTIM
        REAL,    SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::FLWRAT
        REAL,    SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::SBHED
        REAL,    SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::BDFV
        REAL,    SAVE, POINTER, DIMENSION(:,:),CONTIGUOUS::BDHV
        REAL,    SAVE, POINTER, DIMENSION(:)  ,CONTIGUOUS::FHBXWT
        CHARACTER(LEN=16), SAVE,POINTER,DIMENSION(:),CONTIGUOUS ::FHBXNM
      TYPE GWFFHBTYPE
        INTEGER, POINTER ::NBDTIM,NFLW,NHED,IFHBCB,NFHBX1,
     1                           NFHBX2,IFHBSS
        INTEGER, POINTER, DIMENSION(:,:),CONTIGUOUS::IFLLOC
        INTEGER, POINTER, DIMENSION(:,:),CONTIGUOUS::IHDLOC
        REAL,    POINTER, DIMENSION(:)  ,CONTIGUOUS::BDTIM
        REAL,    POINTER, DIMENSION(:,:),CONTIGUOUS::FLWRAT
        REAL,    POINTER, DIMENSION(:,:),CONTIGUOUS::SBHED
        REAL,    POINTER, DIMENSION(:,:),CONTIGUOUS::BDFV
        REAL,    POINTER, DIMENSION(:,:),CONTIGUOUS::BDHV
        REAL,    POINTER, DIMENSION(:)  ,CONTIGUOUS::FHBXWT
        CHARACTER(LEN=16), POINTER, DIMENSION(:),CONTIGUOUS ::FHBXNM
      END TYPE
...
C6------READ AUXILIARY VARIABLES
      IF(NFHBX1.GT.5.OR.NFHBX2.GT.5) THEN
         IF(LSTCHK(1)) THEN
           WRITE(IOUT,*) ' ABORTING. A MAXIMUM OF 5 AUXILIARY',
     &   ' VARIABLES CAN BE DEFINED BY FHB.'
         ENDIF
         CALL USTOP(' ')
      ENDIF
      IF(LSTCHK(3)) THEN
