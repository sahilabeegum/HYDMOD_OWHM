...
C     ******************************************************************
      ...
      DOUBLE PRECISION, DIMENSION(NCOL,NROW,NLAY),INTENT(OUT)::HNEWLAST
C  Local variables
      INTEGER :: I, J, K
C     ------------------------------------------------------------------
C
...
C  Argument-list variables
      ...
      DOUBLE PRECISION, DIMENSION(NCOL,NROW,NLAY),INTENT(IN) ::HNEW
      DOUBLE PRECISION, DIMENSION(NCOL,NROW,NLAY),INTENT(IN) ::HNEWLAST
        ...
        DO I=1,NROW
          DO J=1,NCOL
            IF (IBOUND(J,I,K) > 0) THEN
              HEADCHG = REAL(HNEW(J,I,K)-HNEWLAST(J,I,K))
              IF (HEADCHG > 0.0) THEN
