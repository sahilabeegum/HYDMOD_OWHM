      MODULE GWFRESMODULE
        ...
        INTEGER, SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::IRES
        INTEGER, SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::IRESL
        REAL,    SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::BRES
        REAL,    SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::CRES
        REAL,    SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::BBRES
        REAL,    SAVE, DIMENSION(:),   POINTER,CONTIGUOUS::HRES
        REAL,    SAVE, DIMENSION(:,:), POINTER,CONTIGUOUS::HRESSE
      TYPE GWFRESTYPE
        INTEGER,POINTER   ::NRES,IRESCB,NRESOP,IRESPT,NPTS
        INTEGER,  DIMENSION(:,:), POINTER,CONTIGUOUS::IRES
        INTEGER,  DIMENSION(:,:), POINTER,CONTIGUOUS::IRESL
        REAL,     DIMENSION(:,:), POINTER,CONTIGUOUS::BRES
        REAL,     DIMENSION(:,:), POINTER,CONTIGUOUS::CRES
        REAL,     DIMENSION(:,:), POINTER,CONTIGUOUS::BBRES
        REAL,     DIMENSION(:),   POINTER,CONTIGUOUS::HRES
        REAL,     DIMENSION(:,:), POINTER,CONTIGUOUS::HRESSE
      END TYPE
...
C  Deallocate RES MEMORY
      USE GWFRESMODULE
C
        DEALLOCATE(GWFRESDAT(IGRID)%NRES  )
        DEALLOCATE(GWFRESDAT(IGRID)%IRESCB)
        DEALLOCATE(GWFRESDAT(IGRID)%NRESOP)
        DEALLOCATE(GWFRESDAT(IGRID)%IRESPT)
        DEALLOCATE(GWFRESDAT(IGRID)%NPTS  )
        DEALLOCATE(GWFRESDAT(IGRID)%IRES  )
        DEALLOCATE(GWFRESDAT(IGRID)%IRESL )
        DEALLOCATE(GWFRESDAT(IGRID)%BRES  )
        DEALLOCATE(GWFRESDAT(IGRID)%CRES  )
        DEALLOCATE(GWFRESDAT(IGRID)%BBRES )
        DEALLOCATE(GWFRESDAT(IGRID)%HRES  )
        DEALLOCATE(GWFRESDAT(IGRID)%HRESSE)
C
