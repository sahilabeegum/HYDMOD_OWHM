         ...
         REAL,    SAVE, DIMENSION(:),       POINTER,CONTIGUOUS::W
         REAL,    SAVE, DIMENSION(:,:,:),   POINTER,CONTIGUOUS::EL
         REAL,    SAVE, DIMENSION(:,:,:),   POINTER,CONTIGUOUS::FL
         REAL,    SAVE, DIMENSION(:,:,:),   POINTER,CONTIGUOUS::GL
         REAL,    SAVE, DIMENSION(:,:,:),   POINTER,CONTIGUOUS::V
         REAL,    SAVE, DIMENSION(:),       POINTER,CONTIGUOUS::HDCG
         INTEGER, SAVE, DIMENSION(:,:),     POINTER,CONTIGUOUS::LRCH
       TYPE SIPTYPE
         INTEGER,       POINTER          ::NPARM,IPCALC,IPRSIP
         REAL,          POINTER          ::HCLOSE,ACCL
         REAL,          DIMENSION(:),       POINTER,CONTIGUOUS::W
         REAL,          DIMENSION(:,:,:),   POINTER,CONTIGUOUS::EL
         REAL,          DIMENSION(:,:,:),   POINTER,CONTIGUOUS::FL
         REAL,          DIMENSION(:,:,:),   POINTER,CONTIGUOUS::GL
         REAL,          DIMENSION(:,:,:),   POINTER,CONTIGUOUS::V
         REAL,          DIMENSION(:),       POINTER,CONTIGUOUS::HDCG
         INTEGER,       DIMENSION(:,:),     POINTER,CONTIGUOUS::LRCH
       END TYPE
...
C        SPECIFICATIONS:
C     ------------------------------------------------------------------
      USE GLOBAL,      ONLY:LSTCHK,DEFAULT_KIND
      REAL(DEFAULT_KIND)::CR,CC,CV
...
C  Deallocate SIP DATA
      USE SIPMODULE
C
        DEALLOCATE(SIPDAT(IGRID)%NPARM )
        DEALLOCATE(SIPDAT(IGRID)%IPCALC)
        DEALLOCATE(SIPDAT(IGRID)%IPRSIP)
        DEALLOCATE(SIPDAT(IGRID)%HCLOSE)
        DEALLOCATE(SIPDAT(IGRID)%ACCL  )
        DEALLOCATE(SIPDAT(IGRID)%EL    )
        DEALLOCATE(SIPDAT(IGRID)%FL    )
        DEALLOCATE(SIPDAT(IGRID)%GL    )
        DEALLOCATE(SIPDAT(IGRID)%V     )
        DEALLOCATE(SIPDAT(IGRID)%W     )
        DEALLOCATE(SIPDAT(IGRID)%LRCH  )
        DEALLOCATE(SIPDAT(IGRID)%HDCG  )
C
