...
C         SWI PARAMETERS
        ...
        DOUBLEPRECISION, SAVE, DIMENSION(:,:), POINTER :: SWISOLCR
        DOUBLEPRECISION, SAVE, DIMENSION(:,:), POINTER :: SWISOLCC
        DOUBLEPRECISION, SAVE, DIMENSION(:,:), POINTER :: SWISOLCV
...
C           SWI PARAMETERS
          ...
          DOUBLEPRECISION, DIMENSION(:,:), POINTER :: SWISOLCR
          DOUBLEPRECISION, DIMENSION(:,:), POINTER :: SWISOLCC
          DOUBLEPRECISION, DIMENSION(:,:), POINTER :: SWISOLCV
...
C---------------CALL DE45AP TO SOLVE FOR ZETA
     ...
     2            SWIDE4%NUP,SWIDE4%NBW,ierr)
                ...
                IF (ierr.EQ.0) THEN
                  WRITE(IOUT,'(A,I4,A,I5,A,I4,A,I4,A,I5,A,I8)')
     &             ' STRESS PERIOD=',Kkper,
     &             ' TIMESTEP=',kkstp,
     &             ' LAYER=',k,
     &             ' ZONE=',iz,
